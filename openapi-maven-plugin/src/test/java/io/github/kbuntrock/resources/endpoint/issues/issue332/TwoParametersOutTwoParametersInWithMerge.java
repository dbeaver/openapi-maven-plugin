...
public class TwoParametersOutTwoParametersInWithMerge {

	@GetMapping(value = "", produces = MediaType.APPLICATION_JSON_VALUE)
	@Operation(summary = "Find all", description = "Retrieving all")
	@Parameter(name = "sort", example = "ASC", description = "Description.", required = false, in = ParameterIn.QUERY, schema = @Schema(type = "string"), array = @ArraySchema(schema = @Schema(type = "string")))
	@Parameter(name = "second", example = "hi", description = "Description.", required = false, in = ParameterIn.QUERY, schema = @Schema(type = "string"), array = @ArraySchema(schema = @Schema(type = "string")))
